class CmQsUtil {
    ...
    parse(str, delimiter, eq) {
        ...
        for (i = 0; i < parts.length; ++i) {
            ...
            if (p < 0) {
                ...
                key = this.decode(s.substr(0, p));
                val = this.decode(s.substr(p + 1));
            }
    ...
    stringify(obj, delimiter, eq) {
        ...
        const keys = this.getKeys(obj); // sanity check
